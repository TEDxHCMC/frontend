    ...
    return (
        <div>
                ...
                <div className="page-2-content block absolute top-[65%] left-1/2 z-[1]">
                    <div ref={dissolveRef} className="pb-4">
                        <TextSection
                            ...
                            imgResponsive="h-auto w-[182px] sm:w-[492px] "
                            text="MỞ LÒNG VỚI THỰC TẠI"
                            textSize='text-[10px] sm:text-[20px] md:text-[25px] lg:text-[30px] xl:text-[34px] pl-2'
                        />
                    </div>

                    <p className="sm:pt-10 md:w-auto sm:w-[350px] w-[270px] relative md:-translate-y-0 sm:-translate-y-1/3 -translate-y-[60%] tracking-wide md:leading-[33px] leading-[20px] text-[15px] sm:text-[18px] md:text-[23px] lg:text-[25px]">
            ...
            <div className="page-3-bg h-[100vh] relative grid place-items-center">
                ...
                <motion.div className="container flex absolute bg-transparent z-[2] h-full w-full justify-center" ref={constraintsRef}>
                    <motion.div
                        className="box-1 absolute top-2/4 md:h-[118.5px] md:w-[118.5px] h-[85px] w-[85px] flex justify-center items-center text-center"
                        drag
                    ...
                    <motion.div
                        className="box-2 absolute top-[40%] md:h-[118.5px] md:w-[118.5px] h-[85px] w-[85px] flex justify-center items-center"
                        drag
                        dragConstraints={constraintsRef}
                        dragElastic={0.5}
                    ...
                    <motion.div
                        className="box-3 absolute top-[60%]  md:h-[118.5px] md:w-[118.5px] h-[85px] w-[85px] flex justify-center items-center"
                        drag
                        dragConstraints={constraintsRef}
                        dragElastic={0.5}
                    ...
                    <motion.div
                        className="box-4 absolute top-2/4  md:h-[118.5px] md:w-[118.5px] h-[85px] w-[85px] flex justify-center items-center"
                        drag
                        dragConstraints={constraintsRef}
                        dragElastic={0.5}
