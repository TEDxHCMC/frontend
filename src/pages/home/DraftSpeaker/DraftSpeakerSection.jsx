...
import './draftspeakersection.scss';
        ...
        <div>
            <div className='bg-content h-full'>
                <div className='speaker-heading flex flex-col items-center justify-center 
                                mt-[60px] sm:mt-[80px] md:mt-[100px] lg:mt-[120px] xl:mt-[150px]'>
                    <h1 className='font-bold text-[50px]
                    sm:text-[75px] md:text-[90px] lg:text-[110px] xl:text-[140px]'>
                        CÁC DIỄN GIẢ</h1>
                    <img className="heading-logo mt-5 md:h-[48px] h-5 w-auto"
                        src="./assets/logo/TEDx-logo/TEDx-Black-Short.png"
                    />

                </div>
                <div className='speaker-container h-full flex items-center justify-center p-[4em]'>
                    <div className='grid-speaker-container grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-x-12 gap-y-12 xl:gap-x-22 xl:gap-y-14 '>
                        <div className='speaker speaker-1' id='speaker-1'>
                            <div className='speaker-content mt-7'>
                            ...
                            <div className='button-detail my-4 flex justify-center'>
                        ...
                        <div className='speaker speaker-6' id='6'>
                            ...
                            <div className='image-container mt-5 flex'>
                                <img className='speaker-image'
                ...
                <div className='speaker-overlay-wrap speaker-1'>
                    ...
                    <div className='overlay-wrapper'>
                        <div className='background-wrapper'>
                            <div className='speaker-info speaker-red'>
                            ...
                            <div className='speaker-story speaker-red-black'>
