...
const Footer = () => {
    ...
    return (
        <footer class="container footer pt-[8.125em] pb-[5.625em] mx-auto max-[991px]:px-12 max-[767px]:px-6 max-[479px]:pt-24 max-[479px]:pb-10">
            <div class="main-footer flex justify-between pb-20 gap-x-14 gap-y-14 max-[991px]:flex-col max-[991px]:justify-start max-[991px]:items-start">
