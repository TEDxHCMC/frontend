...
const Header = () => {
  ...
  useEffect(() => {
    const handleScroll = () => {
      ...
      setIsSticky(offset > 104);
      setButtonDisplay(offset > 104);
    };
  ...
  return (
    <header className="bg-white">
      {isAboutPage || isSpeakerPage ? (
        <nav className={`secondary-nav mx-auto flex items-center justify-center lg:px-8 space-x-16 ${isSticky ? 'sticky' : ''}`}>
        ...
        <div>
          ...
          <div className={`secondary-nav mx-auto flex items-center justify-center lg:px-8 space-x-16 ${isSticky ? 'sticky' : ''}`}>
            <div className="first-box flex items-center justify-center">
              <a href="#" className="space-x-4">TEDxHOCHIMINHCITY2024</a>
            </div>
            <div className="second-box"></div>
